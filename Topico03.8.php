                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseFive" class="accordion-collapse collapse" aria-labelledby="Item05" data-bs-parent="#AccordionFase02">
                                    <div class="accordion-body">
                                        ...
                                        É preciso analisar se as metas e objetivos elencados no PIA estão sendo atingidos, se o caminho planejado está funcionando, e se os indicadores mostram que o trabalho técnico está sendo eficaz.

                                        O que é preciso para monitorar o PIA?

                                        <ol type="I">
                                            <li class="wow fadeInLeft" data-wow-delay="0.3s">Estabelecer as metas e indicadores que servirão de parâmetro para a condução do PIA e sua avaliação final; </li>
                                            <li class="wow fadeInLeft" data-wow-delay="0.6s">Selecionar quais elementos usaremos: sistemas de registro e monitoramento (prontuário SUAS, prontuário SUS, SISC, RMA); </li>
                                            ...
                                            <li class="wow fadeInLeft" data-wow-delay="1.3s">Estabelecer uma “agenda” de ações, uma programação do que será feito em dias, semanas e meses; </li>
                                        ...
                                        Na PSC deve ser feito acompanhamento social do adolescente, da família e a entidade deve ser constantemente supervisionada. A entidade também precisa ser capacitada sobre socioeducação e a natureza da medida da PSC. (BRASIL, 2022, p. 14)
                                        ...
                                        O acompanhamento realizado pela equipe do serviço, junto a instituição parceira, deve observar como o adolescente desenvolve as atividades, seus progressos e recuos. Todavia, a unidade do SUAS e as instituições parceiras têm atribuições diferentes, como:

                                        <ul class="none">
                                            <li class="wow fadeInLeft" data-wow-delay="0.3s"><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> Compete às unidades de acompanhamento do SUAS: credenciar, capacitar, acompanhar, supervisionar e dar apoio técnico às entidades parceiras por meios diversos (reuniões semanais, videoconferências, oficinas de capacitação, supervisão continuada);</li>

                                            <li class="wow fadeInLeft" data-wow-delay="0.6s"><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> Cabe ainda às Unidades, definir as rotinas de monitoramento junto à entidade em conjunto com os profissionais de nível superior e os técnicos que acompanham diretamente o adolescente, sendo discutidas coletivamente todas as dificuldades apresentadas e superadas;</li>

                                            <li class="wow fadeInLeft" data-wow-delay="0.9s"><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> A entidade parceira deve apoiar o adolescente no desenvolvimento da atividade, observando sua execução, os cuidados necessários para o bom desempenho e o suporte para identificar dificuldades e dar retorno ao serviço de acompanhamento do SUAS. Elas não podem restringir sua atuação à simples realização de tarefas sem maior envolvimento da entidade com a vida do adolescente, ou mesmo com o sentido da medida. Alterações podem ser pactuadas e sempre informadas à equipe técnica do serviço, para avaliação conjunta.</li>

                                            <li class="wow fadeInLeft" data-wow-delay="1.3s"><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> A frequência é uma obrigação do adolescente, contudo a entidade deve estar aberta para discutir com ele sobre as condições para execução das atividades e os percalços atravessados no cotidiano. Alterações podem ser pactuadas e sempre informadas à equipe técnica do serviço, para avaliação conjunta.</li>
                                        </ul>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseSix" class="accordion-collapse collapse" aria-labelledby="Item06" data-bs-parent="#AccordionFase02">
                                    <div class="accordion-body">
                                        ...
                                        <ol type="I">
                                            <li class="wow fadeInRight" data-wow-delay="0.3s">> Verificar a situação do adolescente após cumprimento da medida socioeducativa, tomando por base suas perspectivas educacionais, sociais, profissionais e familiares; </li>
