    ...
    <div id="main">
        ...
        <div class="main-content container-fluid Texto">
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <div class="page-title">
                        ...
                        <ul class="none">
                            <li class="wow fadeInUp" data-wow-delay="0.3s"><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> <strong>Garantia do direito e do superior interesse do adolescente</strong> - Todo o processo de elaboração e desenvolvimento do PIA, deve buscar a garantia dos direitos fundamentais (saúde, educação, cultura, esporte e lazer, direito à profissionalização e a proteção no trabalho, direito à liberdade, ao respeito e a dignidade e convivência familiar e comunitária);</p>
                            <li class="wow fadeInUp" data-wow-delay="0.6s"><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> <strong>Atenção as especificidades, respeito à diversidade e não discriminação</strong> - A elaboração e a implementação do PIA deve contar, também, com ações que considerem a atenção às diversidades, especificidades e o reconhecimento da singularidade de cada adolescente e de sua família, com vistas a atender adequadamente suas necessidades e fortalecer suas potencialidades;</p>
                            <li class="wow fadeInUp" data-wow-delay="0.9s"><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> <strong>Temporalidade</strong> - A elaboração do PIA e o desenvolvimento de suas estratégias e ações devem, necessariamente, contar com prazos e o menor tempo necessário para que possa viabilizar com segurança, a reintegração do adolescente a suas atividades cotidianas;</p>
                            <li class="wow fadeInUp" data-wow-delay="1.3s"><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> <strong>Participação do adolescente e da família no PIA</strong> - Na elaboração e desenvolvimento do PIA, deve-se assegurar a escuta e o olhar individualizado para o adolescente, a fim de conhecer suas expectativas, desejos, medos e opiniões.</p>
                        </ul>
            ...
            <div class="text-center">
                <a href="Topico03.7.php?AA=<?php echo $AtividadeAvaliativa ?>" class="btn btn-primary" role="button" aria-pressed="true"><i class="fa fa-chevron-left"></i> Voltar</a>
                <a href="Topico03.9.php?AA=<?php echo $AtividadeAvaliativa ?>" class="btn btn-primary" role="button" aria-pressed="true">Próximo <i class="fa fa-chevron-right"></i></a>
            </div>
