            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <div class="page-title">
                        ...
                        <ol>
                            <li>Adolescência, juventude e socioeducação: raça, classe, gênero e criminalização;</li>
                            <li>(Re)culpabilização;</li>
                            <li>Respeito à diversidade e à livre expressão dos adolescentes;</li>
                            <li>Postura técnica;</li>
                            <li>Preservação do sigilo profissional;</li>
                            <li>O/a trabalhador/a que atende as medidas e o ato infracional;</li>
                            <li>Proteção e Responsabilização: uma falsa oposição;</li>
                            <li> PIA e o Sistema de Justiça;</li>
                            <li>Interdisciplinaridade: somos uma equipe!</li>
                        </ol>
                        ...
                        <div class="accordion accordion-flush" id="AccordionFase01">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="Item01" data-bs-parent="#AccordionFase01">
                                    <div class="accordion-body">
                                        ...
                                        <br>
                                        <p style="font-size: 1.5em; color: #ffa73e"><u><strong>Adolescência, juventude e socioeducação: raça, classe, gênero e criminalização</strong></u></p>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="Item02" data-bs-parent="#AccordionFase01">
                                    <div class="accordion-body">
                                        ...
                                        <p style="font-size: 1.5em; color: #ffa73e"><u><strong>(Re)culpabilização: </strong></u></p>
                                        ...
                                        <ul class="none">
                                            <li><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> “Você não pensou na sua mãe quando foi roubar?” ; </li>
                                            <li><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> “Você está vendo o sofrimento e a vergonha que está causando a seus pais?” ; </li>
                                            <li><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> “Por que a senhora não passou mais tempo com seu filho?” ; </li>
                                            <li><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> “Onde a senhora estava quando seu filho cometeu o ato?” ; </li>
                                            <li><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> “Sabia que você mata pessoas ao vender drogas?” ; </li>
                                            <li><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> “Qual o exemplo que você tem dado aos seus filhos?” ; </li>
                                            <li><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> “Isso é coisa que uma menina faça?” ; </li>
                                            <li><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> “Eu vou contar ao juiz o que você está fazendo!” ; </li>
                                            <li><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> “Quem usa drogas não tem futuro!” ; </li>
                                            <li><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> “Está vendo esse garoto aqui? Ele não vem ao atendimento e não quer saber da vida!” . </li>
                                        </ul>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="Item03" data-bs-parent="#AccordionFase01">
                                    <div class="accordion-body">
                                        ...
                                        <p style="font-size: 1.5em; color: #ffa73e"><u><strong>Respeito à diversidade e à livre expressão dos adolescentes </strong></u></p>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="Item04" data-bs-parent="#AccordionFase01">
                                    <div class="accordion-body">
                                        ...
                                        <p style="font-size: 1.5em; color: #ffa73e"><u><strong>Postura técnica </strong></u></p>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseFive" class="accordion-collapse collapse" aria-labelledby="Item05" data-bs-parent="#AccordionFase01">
                                    <div class="accordion-body">
                                        ...
                                        <p style="font-size: 1.5em; color: #ffa73e"><u><strong>Preservação do sigilo profissional </strong></u></p>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseSix" class="accordion-collapse collapse" aria-labelledby="Item06" data-bs-parent="#AccordionFase01">
                                    <div class="accordion-body">
                                        ...
                                        <p style="font-size: 1.5em; color: #ffa73e"><u><strong>O/a trabalhador/a que atende as medidas e o ato infracional</strong></u></p>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseSeven" class="accordion-collapse collapse" aria-labelledby="Item07" data-bs-parent="#AccordionFase01">
                                    <div class="accordion-body">
                                        ...
                                        <p style="font-size: 1.5em; color: #ffa73e"><u><strong>Proteção e Responsabilização: uma falsa oposição </strong></u></p>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseTen" class="accordion-collapse collapse" aria-labelledby="Item10" data-bs-parent="#AccordionFase01">
                                    <div class="accordion-body">
                                        <p style="font-size: 1.5em; color: #ffa73e"><u><strong>PIA e o Sistema de Justiça</strong></u></p>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseEleven" class="accordion-collapse collapse" aria-labelledby="Item11" data-bs-parent="#AccordionFase01">
                                    <div class="accordion-body">
                                        ...
                                        <p style="font-size: 1.5em; color: #ffa73e"><u><strong>Interdisciplinaridade: somos uma equipe!</strong></u></p>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseTwelve" class="accordion-collapse collapse" aria-labelledby="Item12" data-bs-parent="#AccordionFase01">
                                    <div class="accordion-body">
                                        ...
                                        <p style="font-size: 1.5em; color: #ffa73e"><u><strong>Intersetorialidade: Somos uma rede!</strong></u></p>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseThirteen" class="accordion-collapse collapse" aria-labelledby="Item13" data-bs-parent="#AccordionFase01">
                                    <div class="accordion-body">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="Item09">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseNine" aria-expanded="false" aria-controls="flush-collapseNine">
                                        <strong>Atores da elaboração do PIA</strong>
                                    </button>
                                </h2>
                                <div id="flush-collapseNine" class="accordion-collapse collapse" aria-labelledby="Item09" data-bs-parent="#AccordionFase01">
                                    <div class="accordion-body">
